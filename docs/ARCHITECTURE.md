...
**Current autofill release:** P1 Autofill v0.6.18
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.18<br/>local Chrome extension]
...
P1 Autofill v0.6.18 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.18 | Built and actively hardened |
