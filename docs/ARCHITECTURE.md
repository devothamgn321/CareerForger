...
**Current autofill release:** P1 Autofill v0.6.19
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.19<br/>local Chrome extension]
...
P1 Autofill v0.6.19 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.19 | Built and actively hardened |
