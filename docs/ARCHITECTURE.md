...
**Current autofill release:** P1 Autofill v0.6.23
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.23<br/>local Chrome extension]
...
P1 Autofill v0.6.23 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.23 | Built and actively hardened |
