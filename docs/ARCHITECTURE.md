...
**Current autofill release:** P1 Autofill v0.6.25
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.25<br/>local Chrome extension]
...
P1 Autofill v0.6.25 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.25 | Built and actively hardened |
