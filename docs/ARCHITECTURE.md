...
**Current autofill release:** P1 Autofill v0.6.15
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.15<br/>local Chrome extension]
...
P1 Autofill v0.6.15 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.15 | Built and actively hardened |
