...
**Current autofill release:** P1 Autofill v0.6.16
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.16<br/>local Chrome extension]
...
P1 Autofill v0.6.16 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.16 | Built and actively hardened |
