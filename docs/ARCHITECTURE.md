...
**Current autofill release:** P1 Autofill v0.6.22
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.22<br/>local Chrome extension]
...
P1 Autofill v0.6.22 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.22 | Built and actively hardened |
