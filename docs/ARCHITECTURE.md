...
**Current autofill release:** P1 Autofill v0.6.17
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.17<br/>local Chrome extension]
...
P1 Autofill v0.6.17 is local, deterministic, and structurally separated from submission.
...
The current regression suite has 40 tests covering:
...
- package publishing into the extension, strict URL/job-id matching, and cover-letter QA;
...
| P1 Autofill v0.6.17 | Built and actively hardened |
