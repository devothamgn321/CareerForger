...
**Current autofill release:** P1 Autofill v0.6.24
...
flowchart LR
    ...
    EXT[P1 Autofill v0.6.24<br/>local Chrome extension]
...
P1 Autofill v0.6.24 is local, deterministic, and structurally separated from submission.
...
| P1 Autofill v0.6.24 | Built and actively hardened |
